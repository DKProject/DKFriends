...
public class DKFriendStorage {
    ...
    private void createCollections(){
        friends = database.createCollection("dkfriends_friends")
                .field("PlayerId", DataType.UUID, FieldOption.PRIMARY_KEY,FieldOption.NOT_NULL)
                .field("FriendId", DataType.UUID, FieldOption.PRIMARY_KEY,FieldOption.NOT_NULL)
        ...
        friendRequests = database.createCollection("dkfriends_friends_requests")
                .field("ReceiverId", DataType.UUID, FieldOption.PRIMARY_KEY,FieldOption.NOT_NULL)
                .field("RequesterId", DataType.UUID, FieldOption.PRIMARY_KEY,FieldOption.NOT_NULL)
