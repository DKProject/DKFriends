...
public class FriendProfileScreenContext extends ScreenContext<GuiContext> {

    private final Friend selectedFriend;

    public FriendProfileScreenContext(GuiContext guiContext, Screen<GuiContext, ?> page, Friend selectedFriend) {
